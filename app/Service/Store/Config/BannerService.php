...
class BannerService implements StoreServiceInterface
{
	...
	public function serviceCreate(array $requestParams): bool
	{
		...
		return $this->bannerRepository->repositoryCreate($requestParams);
	}
	...
	public function serviceDelete(array $requestParams): int
	{
		...
		return $this->bannerRepository->repositoryWhereInDelete((array)$deleteWhere, (string)'uuid');
	}
	...
	{
		return $this->bannerRepository->repositoryFind(self::searchWhere((array)$requestParams));
	}
}