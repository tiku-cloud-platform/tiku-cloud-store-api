...
//        $items['items'] = DataFormatter::recursionData((array)$items['items']);
	...
	public function serviceCreate(array $requestParams): bool
	{
		...
		return $this->collectionRepository->repositoryCreate($requestParams);
	...
	{
		return $this->collectionRepository->repositoryUpdate([
	...
	public function serviceDelete(array $requestParams): int
	{
		...
		return $this->collectionRepository->repositoryWhereInDelete($deleteWhere, 'uuid');
	}
	...
	{
		return $this->collectionRepository->repositoryFind(self::searchWhere($requestParams));
	}
	...
	{
		return $this->collectionRepository->repositoryCount(self::searchWhere($requestParams));
	}
	...
	{
		return $this->collectionRepository->repositorySum(self::searchWhere($requestParams), 'submit_number');
	}
