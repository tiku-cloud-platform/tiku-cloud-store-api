...
class BannerRepository implements StoreRepositoryInterface
{
    ...
    {
        if (!empty((new StoreBanner)::query()->create($insertInfo))) {
            return true;
        }
    ...
    {
        return (new StoreBanner)::query()->where($updateWhere)->update($updateInfo);
    }
    ...
    {
        return (new StoreBanner)::query()->where($deleteWhere)->delete();
    }
    ...
    {
        return (new StoreBanner)::query()->whereIn($field, $deleteWhere)->delete();
    }
}