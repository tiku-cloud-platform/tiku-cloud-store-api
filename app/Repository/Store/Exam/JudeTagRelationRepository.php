...
use App\Model\Store\StoreExamJudeTagRelation;
use App\Repository\StoreRepositoryInterface;
use Hyperf\Di\Annotation\Inject;

/**
 * 判断题知识点关联
 * Class JudeTagRelationRepository
 * @package App\Repository\Store\Exam
 */
class JudeTagRelationRepository implements StoreRepositoryInterface
{
    /**
     * @Inject()
     * @var StoreExamJudeTagRelation
     */
