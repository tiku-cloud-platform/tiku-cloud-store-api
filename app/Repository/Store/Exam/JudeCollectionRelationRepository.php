...
use App\Model\Store\StoreExamJudeCollectionRelation;
use App\Repository\StoreRepositoryInterface;
use Hyperf\Di\Annotation\Inject;

/**
 * 判断题试卷关联
 * Class JudeCollectionRelationRepository
 * @package App\Repository\Store\Exam
 */
class JudeCollectionRelationRepository implements StoreRepositoryInterface
{
    /**
     * @Inject()
     * @var StoreExamJudeCollectionRelation
     */
